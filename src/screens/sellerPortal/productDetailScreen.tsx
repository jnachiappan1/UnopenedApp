    ...
    <TitleBackHeaderContainer isBack title='Product Details' >
      <View style={styles.imageDetailContainer}>
        <Image
          ...
          resizeMode='stretch' />
        <StatusBadge status={"Sold"} statusStyle={styles.statusStyle} />
        <Text style={styles.titleStyle}>{"Apple AirPods Pro"}</Text>
        <Text style={styles.descriptionStyle}>Brand new, never opened. Comes with original seal and box. No damages</Text>
        <InfoRow title="Brand" subtitle="Apple" />
        <InfoRow title="Category" subtitle="Electronics" />
        <InfoRow title="SKU / Barcode" subtitle="843923-AIRP" />
        <InfoRow title="MRSP" subtitle="$120" subtitleStyle={styles.mrspStyle} />
        <InfoRow title="Listing Price" subtitle="$100" subtitleStyle={styles.mrspStyle} />
      </View>
      <View style={styles.imageDetailContainer}>
        <Text style={styles.headingStyle}>Listing Details</Text>
        <InfoRow title="Created On" subtitle="10 June 2025" showColon />
        <InfoRow title="Last Updated" subtitle="11 June 2025" showColon />
        <InfoRow title="Buyer Name" subtitle="Ravi Rabari" showColon />
