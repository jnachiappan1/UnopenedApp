...
type TermsConditionsScreenProps = NativeStackScreenProps<
  RootStackParamList,
  SCREENS.SellerAgreementScreen
>;

const SellerAgreementScreen: React.FC<TermsConditionsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <TitleBackHeaderContainer isBack title={"Seller Agreement"} containerStyle={{}}>
